...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>游戏运营平台系统后台管理</TITLE>
...
<UL>
  ...
  <UL>
    <LI><A href="include/commodityClass/commodityClassAdd.jsp" target="frmright">新增游戏种类</A> </LI>
    <LI><A href="findAllCommodityClass.action" target=frmright>游戏种类列表</A> </LI>
    <LI><A href="addCommodityPage.action" target=frmright>游戏录入</A> </LI>
    <LI><A href="findAllCommodity.action" target=frmright>游戏列表</A> </LI>
 </LI></UL></DIV>
  ...
  href="#">订单管理</A> 
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="orderform_list.action"  target=frmright>订单列表</A> </LI>
  ...
  href="#">用户管理</A> 
    <DIV class=menu_childs onmouseout=Menus.Hide(0);>
  <UL>
    <LI><A href="users_list.action" target=frmright>用户列表</A> </LI>
...
width="100%" border=0>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#337abb>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=#c4d8ed 
        ...
        <TR height=32>
          ...
          <TD background=images/bg2.gif><SPAN 
            style="FLOAT: left">游戏运营平台系统后台管理</SPAN><SPAN 
            id=dvbbsannounce 
      ...
      src="images/MyHtml.html" frameBorder=0 
