...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=2 height=24>【新增游戏】</TH> 
   </TR>
  <TR>
    <TD class=forumrow width="30%" height=24><div align="right">游戏名称：</div></TD>
  <TD class=forumrowhighlight width="70%" 
      height=24><input type="text" name="commodityName"></TD></TR>
  <TR>
    <TD class=forumrow height=24><div align="right">游戏分类：</div></TD>
  ...
  <TR>
    <TD class=forumrow height=24><div align="right">游戏图片：</div></TD>
    <TD class=forumrowhighlight 
      height=24><input type="file" name="uploadImage"></TD>
  </TR>
  <TR>
    <TD class=forumrow height=24><div align="right">游戏描述：</div></TD>
    <TD class=forumrowhighlight 
      height=24><textarea name="commodityDepict" cols="50" rows="5"></textarea></TD>
  </TR>
  <TR>
    <TD class=forumrow height=24><div align="right">游戏价格：</div></TD>
    <TD class=forumrowhighlight 
      height=24><input type="text" name="commodityPrice"></TD>
  </TR>
  <TR>
    <TD class=forumrow height=24><div align="right">折扣价格：</div></TD>
    <TD class=forumrowhighlight 
      height=24><input type="text" name="fcPrice"></TD>
  </TR>
  <TR>
    <TD class=forumrow height=24><div align="right">游戏总数量：</div></TD>
    <TD class=forumrowhighlight 
