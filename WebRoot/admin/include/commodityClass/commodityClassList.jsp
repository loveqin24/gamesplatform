...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=3 height=24>【游戏种类列表】</TH>  </TR>
  <TR>
    <TD class=forumrow width="30%" height=24><div align="center">游戏种类编号</div></TD>
  <TD class=forumrowhighlight width="70%" 
      height=24><div align="center">游戏种类名称</div></TD>
  </TR>
  ...
  <TR>
    ...
    <TD height=24 class=forumrow><a href="deleteCommodityClass.action?commodityClassID=${commodityClass.commodityClassId}">删除</a></TD>
  </TR>
  </s:iterator>
  <TR>
