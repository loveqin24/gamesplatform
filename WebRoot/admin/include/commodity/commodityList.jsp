...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=10 height=24>【游戏列表】</TH> 
   </TR>
     <TR>
    <TD class=forumrow>游戏编号</TD>
    <TD class=forumrow>游戏名称</TD>
    <TD class=forumrow>游戏分类</TD>
    <TD class=forumrow >生产厂家</TD>
    <TD class=forumrow>游戏价格</TD>
    <TD class=forumrow>折扣价格</TD>
    <TD class=forumrow>游戏总数量</TD>
    <TD class=forumrow>游戏剩余数量</TD>
    <TD class=forumrow>游戏上架时间</TD>
